...
namespace SubripFixer.Behaviours
{
    public class HoverLinkBehaviour : Behavior<ChromiumWebBrowser>
    {
        ...
        public string MyHoverLink
        {
            get { return (string)GetValue(MyHoverLinkProperty); }
            set { SetValue(MyHoverLinkProperty, value); }
        }

        // Using a DependencyProperty as the backing store for MyHoverLink.  This enables animation, styling, binding, etc...
        public static readonly DependencyProperty MyHoverLinkProperty =
            DependencyProperty.Register("MyHoverLink", typeof(string), typeof(HoverLinkBehaviour), new PropertyMetadata(string.Empty));
